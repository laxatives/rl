...
Algorithms in chapters 3-6 (Linear Programming, Dynamic Programming, Monte Carlo Control/Prediction On/Off Policy, Temporal Difference Control/Prediction On/Off Policy)
