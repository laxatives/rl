...
class Agent:
    ...
    def __init__(self, alpha=2/(5*60), dispatch_gamma=0.9999, idle_reward=-2/(60*60), reposition_gamma=0.9995):
        self.dispatcher = approximation.FunctionApprox(dispatch_gamma)
