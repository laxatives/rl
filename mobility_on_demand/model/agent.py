...
class Agent:
    ...
    def __init__(self, dql=True, alpha=2/(5*60), gamma=0.9999, idle_reward=-2/(60*60)):
        self.dispatcher = dispatcher.Dql(alpha, gamma, idle_reward) if dql \
            else dispatcher.Sarsa(alpha, gamma, idle_reward)
